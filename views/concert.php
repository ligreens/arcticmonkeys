...
<div id="concertclick" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 " style="padding:0;">
    ...
    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
        ...
        <img src="images/concert.jpg" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 img-responsive">
            ...
            <a class="add  btn btn-primary pull-right" href="/update.concert?id=<?= $value['id'] ?>" role='button'>Update</a>
        <a class="add  btn btn-primary pull-right deletebtn" href="/delete?id=<?= $value['id'] ?>">Delete</a>
